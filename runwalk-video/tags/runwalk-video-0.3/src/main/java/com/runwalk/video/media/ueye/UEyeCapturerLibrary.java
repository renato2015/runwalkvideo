...
public class UEyeCapturerLibrary implements StdCallLibrary {
	 ...
	 */
	public static native int GetCameraNames(Pointer uEyeCameraListPointer);
	/**
	...
	public static native void GetFrameDropInfo(IntByReference cameraHandle, long[] frameDropInfo);
